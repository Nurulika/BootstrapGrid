// src/lib.rs
/*
 * Core library for BootstrapGrid
 */
...
#[derive(Debug)]
pub struct BootstrapGridProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BootstrapGridProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BootstrapGrid processing");
    
    let mut processor = BootstrapGridProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BootstrapGridProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BootstrapGridProcessor::new(false);
